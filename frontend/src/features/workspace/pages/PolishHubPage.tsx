...
export default function PolishHubPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="flex items-center gap-3 mb-2">
        ...
        <h1 className="text-[2rem] font-bold tracking-tight">润色</h1>
      </div>
      <p className="text-muted-foreground mb-8 ml-13">选择作品开始 AI 润色，优化文字表达和叙事节奏</p>
      ...
      {isLoading ? (
        ...
        <NovelGrid novels={filteredNovels} baseHref="/polish" emptyMessage="暂无作品，先去工作台创建吧" />
      )}
