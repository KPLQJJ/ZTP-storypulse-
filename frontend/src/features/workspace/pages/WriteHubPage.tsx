  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="flex items-center gap-3 mb-2">
        ...
        <h1 className="text-[2rem] font-bold tracking-tight">创作</h1>
      </div>
      <p className="text-muted-foreground mb-8 ml-13">选择作品进入创作工坊，三面板布局助你高效写作</p>
      ...
      {isLoading ? (
        ...
        <NovelGrid novels={filteredNovels} baseHref="/write" emptyMessage="暂无作品，先去工作台创建吧" />
      )}
